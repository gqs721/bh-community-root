...
//    }
    ...
    protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue) {
        ...
        if (isLoginAttempt(request, response)) {
            ...
            if(!flag){
                responseResult(request,response,ResultCodeEnum.TOKEN_BE_USED.getCode(), ResultCodeEnum.TOKEN_BE_USED.getMsg());
            }
        } else {
            flag = false;
    ...
    public static void responseResult(ServletRequest request, ServletResponse response1, int code, String msg){
